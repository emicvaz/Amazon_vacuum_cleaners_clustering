...
resultado<-as.data.frame(t(resultado_datos))
...
rownames(resultado)<-c(1:220)
View(resultado)
table(is.na(resultado)) #False 168 #True 52 
write.csv(resultado,"aspiradoras.csv")
save(resultado, file = "aspiradoras.RData")
